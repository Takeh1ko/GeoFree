...
2. Скопируйте нижнее значение из поля Address (в примере ниже это значение — 85.137.95.246)
...
3. При необходимости введите свой IP. Если IP не указывать, будет предложено использовать `85.137.95.246`
